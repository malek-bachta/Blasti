...
public final class MovieDetailBinding implements ViewBinding {
  ...
  private MovieDetailBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
  ...
  public static MovieDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MovieDetailBinding((ConstraintLayout) rootView, button, button2, imageView2,
